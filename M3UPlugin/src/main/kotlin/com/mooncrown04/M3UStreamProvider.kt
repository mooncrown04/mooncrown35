...
class M3UStreamProvider : MainAPI() {
    ...
    override var mainUrl = "https://example.com" // İsteğe bağlı
    override val supportedTypes = setOf(TvType.Live)
    override var lang = "tr"
    override val hasMainPage = true

    private val m3uUrl = "https://raw.githubusercontent.com/mooncrown04/m3u/refs/heads/main/birlesik.m3u" // Buraya gerçek M3U linkini koy
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        return newHomePageResponse(
            listOf(
                HomePageList("M3U Playlist", channels, isHorizontalImages = true)
            ),
            hasNext = false
        )
    }
